...
import pytz
blindurl = "https://api.bland.ai/v1/calls"
...
def fetchassignmentsAndCall(phone_number):
    try:
        ...
        if connection:
            ...
            connection.close()
            assignments_result = f"Remind {student.name} about the next assignment they have due. Only list one at a time." + assignments_result
            print(assignments_result)
            #Calling Student
            payload = {
                "phone_number": student.personal_phone_number,
                "task": assignments_result,
                "model": "base",
                "temperature": 0.3,
		...
		"record": True
            ...
            headers = {
                "authorization": "sk-4jn8xbodug5n5l2oczuxlp281f2gpayk3zpzcjqk7f2nimm87xtlixfn0m3qm46969",
                "Content-Type": "application/json"
            }

            response = requests.request("POST",blindurl, json=payload, headers=headers)
...
if __name__ == "__main__":
    fetchassignmentsAndCall("5592813621")
